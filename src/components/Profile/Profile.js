    ...
    <section className="profile">
        ...
        <div className="profile__form-item">
          ...
          <input
            ...
            className={
              editProfile
                ? "profile__form-value"
                : "profile__form-value profile__form-value_diasbled"
            }
            name="name"
          ...
          />
          {userNameDirty && (
            <span className="profile__form-error">{userNameError}</span>
          )}
        </div>
        <div className="profile__form-item">
          ...
          <input
            ...
            name="email"
            value={editProfile ? userEmail : context.email}
            placeholder="Email"
            required
          />
          {userEmailDirty && (
            <span className="profile__form-error">{userEmailError}</span>
          )}
        </div>
        <button
          disabled={
          ...
          className={
            editProfile
              ? "profile__form-btn"
              : "profile__form-btn profile__form-btn_none"
          }
      ...
      <div className="profile__nav">
        <button
          className={
            editProfile
              ? "profile__nav-btn profile__form-btn_none"
              : "profile__nav-btn"
          }
        ...
        <button
          className="profile__nav-btn profile__nav-btn_red"
